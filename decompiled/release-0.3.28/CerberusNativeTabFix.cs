...
[BepInDependency("operator.modapi", "0.2.0-alpha.5")]
public sealed class CerberusNativeTabFix : BasePlugin
{
	...
	public override void Load()
	{
		...
		if (!string.Equals(OperatorApi.ApiVersion, "0.2.0-alpha.5", StringComparison.Ordinal))
		{
			((BasePlugin)this).Log.LogError((object)("Modded Operations requires Operator Mod API 0.2.0-alpha.5, but Core exposes " + OperatorApi.ApiVersion + ". Adapter startup was refused."));
			return;
		}
